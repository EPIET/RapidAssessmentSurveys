...
be downloaded [here](https://github.com/EPIET/RapidAssessmentSurveys/raw/master/docs/RAS_VCE_R_pack.zip).  

You can then access the R guide for this case study in two ways:

- Click on [this link](https://epiet.github.io/RapidAssessmentSurveys/RAS_VCE_R_guide.html) 
