...
4.  `RAS_VCE_R_code_2022.Rmd`: R markdown with coding solutions for each task
...
them into the current R session. Once the packages are installed, you will also 
need to rerun this code chunk at the beginning of each session, to ensure that 
