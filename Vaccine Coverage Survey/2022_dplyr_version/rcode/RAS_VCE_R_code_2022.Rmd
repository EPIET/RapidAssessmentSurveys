...
Use `gtsummary` functions to choose how the table looks and add in some extras, 
such as a total count column, labels (in bold and italicised) and column headers. 
...
Use `flextable` to create a publication-ready table. 
...
Estimate vaccine coverage for DTP3 stratified by minority group and urban/rural area of residence
...
Combine all of the tables above
...
Tidy up the decimals and add percentages
...
Use `flextable` as previously to make a publishable table. 
